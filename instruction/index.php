...
<a href="https://ddosukraine.com.ua/vps/" data-toggle="tooltip" data-title="Не гвалтуйте свій ПК та домашню мережу, виділіть трохи часу та розгорніть справжню боротьбу з ворогом!" class="btn btn-sm btn-danger  mt-3"><i class="fas fa-server"></i> Інструкція по розгортанню VPS</a>
...
<!-- Ubuntu Tab -->
  ...
  <div class="tab-pane fade show active" id="ubuntu" role="tabpanel" aria-labelledby="ubuntu-tab">
    ...
    <h4>Інструкція для встановлення софту для Ubuntu</h4>
...
<!-- Windows Tab -->
  ...
  <ol>
    ...
    <ul class="nav nav-tabs mt-5 mb-3" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="pyton-tab" data-toggle="tab" href="#pyton" role="tab" aria-controls="pyton" aria-selected="true">Інструкція для Python</a>
        </li>
        <li class="nav-item" role="presentation">
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show img active" id="pyton" role="tabpanel" aria-labelledby="pyton-tab">

        <h3>Налаштування через Python</h3>
        ...
        <ol>
            ...
            <li>Натисніть:
                ...
                вікні терміналу прописуємо команду:
